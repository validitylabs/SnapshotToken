...
__News flash: No more need using the initShell scripts anymore, because we are using npx right now!__
...
- Ensure you are using the same solidity version in `config/solcpiler.json` too (determine version [here](https://github.com/ethereum/solc-bin/tree/gh-pages/bin)).
